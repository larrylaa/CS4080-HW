...
/*
Ch.24 Q2: Added native call arity check in callValue().
See lines 129-146 (native branch) and 406-423 (defineNative arity wiring).

Example:
Input: clock(1);
Output: [line 1] runtime error "Expected 0 arguments but got 1."
*/
