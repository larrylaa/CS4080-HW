...
/*
Ch.24 Q3: Native calls can now fail cleanly by returning false after runtimeError().
See lines 129-146 (callValue flow), 431-467 (checked natives), and 470-498.

Example:
Input: sqrt(\"oops\");
Output: [line 1] runtime error "sqrt() expects a number."
*/
