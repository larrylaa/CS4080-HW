...
/*
Ch.24 Q1: Cached CallFrame ip in a local register-friendly variable inside run().
See lines 14-15, 159-188, and 346-352 for STORE_IP()/LOAD_FRAME() sync.

Benchmark summary (DEBUG disabled, O2):
- loop benchmark (5,000,000 iterations): opt avg 0.374s vs base avg 0.404s
- call benchmark (1,000,000 inc() calls): roughly equal around 0.10s
